...
import { EditCustomers_customersComponent } from './modals/edit.Customers_customers.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Customers
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-Customers_customers',
  templateUrl: './Customers_customers.component.html',
  styleUrls: ['./Customers_customers.component.scss'],
  animations: [
...
export class Customers_customersComponent extends GridComponent implements OnInit {
  ...
  public _Name: FormControl;
  public _Surname: FormControl;
  public _Email: FormControl;
  public _Customer_id: FormControl;
  ...
  public entityBaseUrl() {
    return 'magic/modules/Customers/customers';
  }
  ...
  protected read(filter: any) {
    return this.httpService.Customers_customers.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.Customers_customers.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.Customers_customers.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this._Name = this.createFormControl('Customers.Name.like');
    this._Surname = this.createFormControl('Customers.Surname.like');
    this._Email = this.createFormControl('Customers.Email.like');
    this._Customer_id = this.createFormControl('Customers.Customer_id.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditCustomers_customersComponent, {
