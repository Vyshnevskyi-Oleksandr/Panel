...
/**
 * Modal dialog for editing your existing Customers entity types, and/or
 * creating new entity types of type Customers.
 */
@Component({
  templateUrl: './edit.Customers_customers.component.html'
})
export class EditCustomers_customersComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditCustomers_customersComponent>,
  ...
  protected getUpdateMethod() {
    return this.service.Customers_customers.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.Customers_customers.create(this.data.entity);
  }
