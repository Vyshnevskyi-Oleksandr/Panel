...
export class HttpService {
  ...
  /**
   * HTTP CRUD service methods for your 'Customers_customers' entities.
   */
  get Customers_customers() : ICrudEntity {
    return {

      delete: (filter: any) => {
        return this.httpClient.delete<DeleteResponse>(
          environment.apiUrl +
          'magic/modules/Customers/customers' +
      ...
      count: (filter: any) => {
        return this.httpClient.get<CountResponse>(
          environment.apiUrl +
          'magic/modules/Customers/customers-count' +
          this.getQueryArgs(filter));
      },
  ...
  /**
   * HTTP CRUD service methods for your 'Customers_Goods' entities.
   */
  get Customers_Goods() : ICrudEntity {
    return {

      delete: (filter: any) => {
        return this.httpClient.delete<DeleteResponse>(
          environment.apiUrl +
          'magic/modules/Customers/Goods' +
          this.getQueryArgs(filter));
      },
      ...
      count: (filter: any) => {
        return this.httpClient.get<CountResponse>(
          environment.apiUrl +
          'magic/modules/Customers/Goods-count' +
          this.getQueryArgs(filter));
      },
